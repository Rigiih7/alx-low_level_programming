...
/**
 * _strncmp - for comparing two given strings
 * @s1: first string
 * @s2: second string
 * @n: the maximum no of bytes to be compared
 *
 * Return: 0 on success(if first n bytes of s1 and s2 are equal)
 */
...
/**
 * _close - for closing a file descriptor
...
/**
 * _read - for reading from a given file
 * @fd: file descriptor that will be read from
...
/**
 * elf_magic - for printing the ELF magic
 * @buffer: ELF header
 */
...
/**
 * elf_class - for printing the ELF class
 * @buffer: ELF header
 *
 * Return: the bit type
 */
...
/**
 * elf_data - for printing the ELF data
 * @buffer: ELF header
 *
 * Return: 1 for big endian, 0 if false
 */
...
/**
 * elf_version - for printing the ELF version
 * @buffer: ELF header
 */
...
/**
 * elf_osabi - for printing the ELF OS/ABI
 * @buffer: ELF header
 */
...
/**
 * elf_abivers - for printing ELF version
 * @buffer: ELF header
 */
...
/**
 * elf_type - for printing the ELF type
 * @buffer: ELF header
 * @big_endian: the endianness
 */
 ...
 * @buffer: a string with entry point address
 * @bit_mode: bit type
 * @big_endian: the endianness
 */
...
/**
 * main - for copying the contents a given file to another
